...
<div class="col center s12 l5"><br><br>
    <form class="form" method="post" action="<?php echo base_url('index.php/login')?>">
        <div class="row login-logo center" style="width: 200px!important; height:200px; border: 2px solid white; border-radius: 100px">
            <img  src="<?PHP echo base_url();?>assets/img/logo_gmv.png" style="width:100%;height:100%;">
        </div><br>
        <div  class="row">
